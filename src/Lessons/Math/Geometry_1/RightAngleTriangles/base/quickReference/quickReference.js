...
export class QRMain extends PopupBoxCollection {
  ...
  constructor(
    ...
    const modifiers = {
      longest_side: click(coll.pulseOpposite, [coll], colors.sides),
      right_angle: click(coll.pulseRightAngle, [coll], colors.rightAngle),
      equal: click(coll.pulseEquation, [coll], colors.sides),
    };
...
export class QRPythagorus extends PopupBoxCollection {
  ...
  constructor(
    ...
    const { colors } = this.layout;
    const modifiers = {
      hypotenuse: click(coll.pulseOpposite, [coll], colors.sides),
      two_side: click(coll.pulsePerpendicularSides, [coll], colors.sides),
      Pythagorean_Theorem: click(coll.pulseEquation, [coll], colors.sides),
    };
...
export class QRRightAngleTriangleArea extends PopupBoxCollection {
  ...
  constructor(
    ...
    const { colors } = this.layout;
    const modifiers = {
      perpendicular_sides: click(coll.pulsePerpendicularSides, [coll], colors.sides),
    };
