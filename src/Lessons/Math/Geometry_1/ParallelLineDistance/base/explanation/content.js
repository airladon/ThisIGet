...
class Content extends PresentationLessonContent {
  ...
  addSections() {
    ...
    this.addSection(common, {
      ...
      modifiers: {
        point_and_a_line: this.bindShowQR('point_line_distance/base', 'Main'),
    ...
    this.addSection(common, content, {
      show: [topLine, bottomLine, point, leftLine, bottomLeftAngle],
      modifiers: {
        interior_angles: this.bindShowQR('related_angles/base', 'Interior'),
    ...
    this.addSection(common, content, {
      ...
      modifiers: {
        ...
        rectangle: this.bindShowQR('rectangles_and_squares', 'Rectangle'),
      },
    });
