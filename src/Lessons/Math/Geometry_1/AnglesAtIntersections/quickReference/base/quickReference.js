...
export class QROpposite extends PopupBoxCollection {
  ...
  constructor(
    ...
    const modifiers = {
      Opposite_angles: click(opp.toggleOpposite, [opp], colors.qrAnglesAtIntersections_angle1),
    };
  ...
  show() {
    ...
    const opp = this._collection;
    const { colors } = this.layout;
    opp.setAngle(1, colors.qrAnglesAtIntersections_angle1, 'a');
    opp.setAngle(2, colors.qrAnglesAtIntersections_angle1, 'b');
    opp.setAngle(3, colors.qrAnglesAtIntersections_angle1, 'a');
    opp.setAngle(4, colors.qrAnglesAtIntersections_angle1, 'b');
    opp.hideAll();
...
export class QRCorresponding extends PopupBoxCollection {
  ...
  constructor(
    ...
    const modifiers = {
      Corresponding_angles: click(
        three.toggleCorresponding, [three], colors.qrAnglesAtIntersections_angle1,
      ),
      parallel: click(three.pulseParallel, [three], colors.qrAnglesAtIntersections_lines),
      two_lines: click(three.pulseParallel, [three], colors.qrAnglesAtIntersections_lines),
      intersecting: click(
        three.pulseIntersecting, [three],
        colors.qrAnglesAtIntersections_intersectingLine,
      ),
      corresponding_angles_are_always_equal: highlight(colors.qrAnglesAtIntersections_angle3),
      two_lines_are_always_parallel: highlight(colors.qrAnglesAtIntersections_angle3),
    };
  ...
  show() {
    ...
    three.setAngle('A1', colors.qrAnglesAtIntersections_angle1, 'a');
    three.setAngle('A2', colors.qrAnglesAtIntersections_angle1, 'a');
    three.setAngle('B1', colors.qrAnglesAtIntersections_angle1, 'b');
    three.setAngle('B2', colors.qrAnglesAtIntersections_angle1, 'b');
    three.setAngle('C1', colors.qrAnglesAtIntersections_angle1, 'c');
    three.setAngle('C2', colors.qrAnglesAtIntersections_angle1, 'c');
    three.setAngle('D1', colors.qrAnglesAtIntersections_angle1, 'd');
    three.setAngle('D2', colors.qrAnglesAtIntersections_angle1, 'd');
    three.hideAll();
...
export class QRAlternate extends PopupBoxCollection {
  ...
  constructor(
    ...
    const modifiers = {
      ...
      two_lines: click(three.pulseParallel, [three], colors.qrAnglesAtIntersections_lines),
      parallel: click(three.pulseParallel, [three], colors.qrAnglesAtIntersections_lines),
      alternate_angles_are_always_equal: highlight(colors.qrAnglesAtIntersections_angle3),
      two_lines_are_always_parallel: highlight(colors.qrAnglesAtIntersections_angle3),
    };
  ...
  show() {
    ...
    const { colors } = this.layout;
    three.setScenarios('qr');
    three.setAngle('A1', colors.qrAnglesAtIntersections_angle1, 'c');
    three.setAngle('A2', colors.qrAnglesAtIntersections_angle1, 'a');
    three.setAngle('B1', colors.qrAnglesAtIntersections_angle1, 'd');
    three.setAngle('B2', colors.qrAnglesAtIntersections_angle1, 'b');
    three.setAngle('C1', colors.qrAnglesAtIntersections_angle1, 'a');
    three.setAngle('C2', colors.qrAnglesAtIntersections_angle1, 'c');
    three.setAngle('D1', colors.qrAnglesAtIntersections_angle1, 'b');
    three.setAngle('D2', colors.qrAnglesAtIntersections_angle1, 'd');
    three.hideAll();
...
export class QRInterior extends PopupBoxCollection {
  ...
  constructor(
    ...
    const { colors } = this.layout;
    const modifiers = {
      Interior_angles: click(three.toggleInterior, [three], colors.qrAnglesAtIntersections_angle1),
      intersecting: click(
        three.pulseIntersecting, [three],
        colors.qrAnglesAtIntersections_intersectingLine,
      ),
      two_lines: click(three.pulseParallel, [three], colors.qrAnglesAtIntersections_lines),
      parallel: click(three.pulseParallel, [three], colors.qrAnglesAtIntersections_lines),
      interior_angles_always_add_to_180º: highlight(colors.qrAnglesAtIntersections_angle3),
      two_lines_are_always_parallel: highlight(colors.qrAnglesAtIntersections_angle3),
    };
  ...
  show() {
    ...
    const { colors } = this.layout;
    three.setScenarios('qr');
    three.setAngle('A2', colors.qrAnglesAtIntersections_angle1, '180º – a');
    three.setAngle('B2', colors.qrAnglesAtIntersections_angle1, '180º – b');
    three.setAngle('C1', colors.qrAnglesAtIntersections_angle1, 'b');
    three.setAngle('D1', colors.qrAnglesAtIntersections_angle1, 'a');
    three.hideAll();
