...
class Content extends PresentationLessonContent {
  ...
  addSections() {
    ...
    this.addSection({
      ...
      modifiers: {
        supplementary: this.qr('Math/Geometry_1/AdjacentAngles/base/Supplementary', colors.diagram.action),
    ...
    this.addSection({
      ...
      modifiers: {
        supplementary: this.qr('Math/Geometry_1/AdjacentAngles/base/Supplementary', colors.angle3),
