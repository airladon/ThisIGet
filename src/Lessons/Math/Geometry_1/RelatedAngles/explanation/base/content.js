...
//    this.iconLinkGrey = imgLinkGrey;
  ...
  addSections() {
    ...
    this.addSection({
      ...
      modifiers: {
        supplementary: this.qr('Math/Geometry_1/AdjacentAngles/base/SupplementaryPres', colors.diagram.action),
    ...
    this.addSection({
      ...
      modifiers: {
        supplementary: this.qr('Math/Geometry_1/AdjacentAngles/base/SupplementaryPres', colors.angle3),
