...
export default function lessonLayout() {
  ...
  layout.oppositeEqn = {
    ...
    options: {
      ...
      elements: {
        a: { color: colors.qrAngle1 },
        b: { color: colors.qrAngle2 },
        c: { color: colors.qrAngle3 },
        d: { color: colors.qrAngle4 },
        equals: { text: ' = ' },
        plus: { text: ' + ' },
        minus: { text: ' – ' },
        _180: { text: '180º' },
