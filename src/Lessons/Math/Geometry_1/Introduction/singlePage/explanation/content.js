...
class Content extends SinglePageLessonContent {
  ...
  setContent() {
    ...
    this.content = [
      ...
      makeFig('id_figure3_asdf', diag._fig3, 'fit', new Rect(-2.5, -1.5, 5, 3)),
      // makeFig('id_figure3a_asdf', [], 'fit', new Rect(-2.3, -1.5, 4.6, 3)),
      makeFig('id_figure4_asdf', diag._fig4, 'fit', new Rect(-2.5, -1.5, 5, 3)),
      makeFig('id_figure5_asdf', diag._fig5, 'fit', new Rect(-2.5, -1.5, 5, 3)),
      makeFig('id_figure6_asdf', diag._fig6, 'fit', new Rect(-2.5, -1.5, 5, 3)),
      makeFig('id_figure7_asdf', diag._fig7, 'fit', new Rect(-2.5, -1.5, 5, 3)),
      makeFig('id_figure8_asdf', diag._fig8, 'fit', new Rect(-2.5, -1.5, 5, 3)),
