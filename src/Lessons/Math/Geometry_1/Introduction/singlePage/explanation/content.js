...
class Content extends SinglePageLessonContent {
  ...
  getContent() {
    ...
    const content = [
      ...
      'For example, a |wheel| is a physical thing. It is made of different materials, has mass, size, location and smell. A wheel can be abstracted into a |_shape_| by removing a lot of these details, but keeping the outline.',
