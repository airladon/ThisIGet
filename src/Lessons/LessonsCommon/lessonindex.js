      ...
      topics: {
        examples: {
          static: {
            ...
            description: 'Examples showing relationship between diameter, radius and circumference',
            htmlTitle: 'Radius, diameter and circumference calculationg examples',
            htmlDescription: 'Examples showing how to calculate radius, diameter and circumference of circles',
            fullLesson: true,
          },
        },
        explanation: {
