...
export default function diagramLayout() {
  ...
  layout.line = {
    ...
    options: {
      ...
      width: layout.width,
      color: colors.qrAnglesAtIntersections_lines,
  ...
  layout.oppositeAngle1 = joinObjects({}, layout.angle, {
    name: 'angle1',
    options: { color: colors.qrAnglesAtIntersections_angle1 },
  });
  layout.oppositeAngle2 = joinObjects({}, layout.angle, {
    name: 'angle2',
    options: { color: colors.qrAnglesAtIntersections_angle2 },
  });
  layout.oppositeAngle3 = joinObjects({}, layout.angle, {
    name: 'angle3',
    options: { color: colors.qrAnglesAtIntersections_angle3 },
  });
  layout.oppositeAngle4 = joinObjects({}, layout.angle, {
    name: 'angle4',
    options: { color: colors.qrAnglesAtIntersections_angle4 },
  });
  ...
  layout.oppositeEqn = {
    ...
    options: {
      ...
      elements: {
        a: { color: colors.qrAnglesAtIntersections_angle1 },
        b: { color: colors.qrAnglesAtIntersections_angle2 },
        c: { color: colors.qrAnglesAtIntersections_angle3 },
        d: { color: colors.qrAnglesAtIntersections_angle4 },
        equals: { text: ' = ' },
        plus: { text: ' + ' },
        minus: { text: ' – ' },
        _180: { text: '180º' },
  ...
  layout._3LinesLine3 = joinObjects({}, layout.line, {
    ...
    options: {
      ...
      color: colors.qrAnglesAtIntersections_intersectingLine,
      angle: 1,
    },
    mods: {
      interactiveLocation: new Point(layout.length / 2 * 0.9, 0),
  ...
  //   name: 'line4',
  //   options: {
  //     color: colors.qrIntersectingLine,
  //   },
  // });
