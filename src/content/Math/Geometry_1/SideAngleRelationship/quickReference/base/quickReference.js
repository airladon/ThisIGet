...
export default class QRSideAngleRelationship extends PopupBoxCollection {
  ...
  constructor(
    ...
    const modifiers = {
      Angles_opposite_longer_sides: click(coll.pulseLargestSideAngle, [coll], colors.qrSideAngleRelationshipAngles),
      angles_opposite_shorter_sides: click(coll.pulseSmallestSideAngle, [coll], colors.qrSideAngleRelationshipAngles),
      sides_opposite_larger_angles: click(coll.pulseLargestSideAngle, [coll], colors.qrSideAngleRelationshipSides),
      sides_opposite_smaller_angles: click(coll.pulseSmallestSideAngle, [coll], colors.qrSideAngleRelationshipSides),
    };
